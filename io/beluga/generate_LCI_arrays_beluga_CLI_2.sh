...
cd bw2preagg_CLI
python generate_LCI_samples_CLI.py --project_name=ei36co --database_name=ei36co --result_dir=/home/plesage/scratch/preagg_ei36co --samples_batch=2 --parallel_jobs=4 --number_of_slices=$SLURM_ARRAY_TASK_COUNT --slice_id=$SLURM_ARRAY_TASK_ID